...
[_SYMBOLS] = LAYOUT(
  ...
  KC_GRV,  KC_EXLM, KC_UNDS, KC_QUOT, KC_LPRN, KC_RPRN,                         KC_EQL,  KC_4,  KC_5,  KC_6,  KC_HASH, _______,
 ...
 */
  [_ADJUST] = LAYOUT(
  KC_LOCK, KC_QWERTY, KC_QWERTY_MAC, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,
